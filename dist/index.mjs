...
/* harmony import */ var _useshortcut_client__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(5914);
...
const notion = new _notionhq_client__WEBPACK_IMPORTED_MODULE_1__/* .Client */ .KU({auth: process.env.NOTION_TOKEN});
const shortcut = new _useshortcut_client__WEBPACK_IMPORTED_MODULE_2__.ShortcutClient(process.env.SHORTCUT_TOKEN);
